...
// Останній оператор АБО для випадку, якщо отримаємо аргумент з пустою строкою
...
console.log(evenFn(0)); // "Function evenFn got an incorrect value"
console.log(evenFn(-20)); // "Function evenFn got an incorrect value"
/*
 * #5
 *
